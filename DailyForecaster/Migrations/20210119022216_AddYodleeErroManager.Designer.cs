...
namespace DailyForecaster.Migrations
{
    ...
    [Migration("20210119022216_AddYodleeErroManager")]
    partial class AddYodleeErroManager
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DailyForecaster.Models.BonusModel", b =>
                {
                    b.Property<string>("BonusModelId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("DailyForecaster.Models.Budget", b =>
                {
                    ...
                    b.Property<bool>("SimulationBool")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("DailyForecaster.Models.IncludeYodlee", b =>
                {
                    b.Property<string>("IncludeYodleeId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasKey("IncludeYodleeId");

                    b.HasIndex("CollectionsId");

                    b.ToTable("IncludeYodlee");
                });

            modelBuilder.Entity("DailyForecaster.Models.IncreaseModel", b =>
                {
                    b.Property<string>("IncreaseModelId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasKey("IncreaseModelId");

                    b.HasIndex("BudgetTransactionId");

                    b.HasIndex("SimulationAssumptionsId");

                    b.ToTable("IncreaseModel");
                });
            ...
            modelBuilder.Entity("DailyForecaster.Models.YodleeErrorManager", b =>
                {
                    b.Property<string>("YodleeErrorManagerId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<string>("YodleeFail")
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("YodleeErrorManagerId");

                    b.ToTable("YodleeErrorManager");
                });
            ...
            modelBuilder.Entity("DailyForecaster.Models.BonusModel", b =>
                {
                    ...
                    b.HasOne("DailyForecaster.Models.SimulationAssumptions", "SimulationAssumptions")
                        .WithMany("BonusModels")
                        .HasForeignKey("SimulationAssumptionsId");
                });
            ...
            modelBuilder.Entity("DailyForecaster.Models.UserCollectionMapping", b =>
                {
                    b.HasOne("DailyForecaster.Models.AspNetUsers", null)
